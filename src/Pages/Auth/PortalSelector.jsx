...
import { Users, Shield, ShieldAlert, BadgeCheck } from 'lucide-react';
    ...
    <div className="dashboard">
      ...
      <section className="stats-section">
        <div className="stats-grid" style={{gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem'}}>
           ...
           <div className="stat-card" onClick={() => navigate('/moderator-login')} style={{cursor:'pointer', padding: '2rem', textAlign: 'center'}}>
              <div className="stat-icon solved" style={{margin: '0 auto 1rem auto', width: '60px', height: '60px'}}><Shield size={32} /></div>
              <div className="stat-content">
                 <h3 style={{fontSize: '1.5rem', marginBottom: '0.5rem'}}>Moderator Portal</h3>
